...
go mod init tyk_plugin
go mod edit -replace github.com/jensneuse/graphql-go-tools=github.com/TykTechnologies/graphql-go-tools@6ff6aba4c612
go get github.com/TykTechnologies/tyk@c87aecbd6de342111ccd1a3ee09f5cfbdfb77a16
```
{{< tab_end >}}
...
go mod init tyk_plugin
go mod edit -replace github.com/jensneuse/graphql-go-tools=github.com/TykTechnologies/graphql-go-tools@6ff6aba4c612
go get github.com/TykTechnologies/tyk@ba21e46a736c705e4215a23e1349e16b76801850
```
{{< tab_end >}}
{{< tab_start "3.0.6" >}}
```bash
go mod init tyk_plugin
go mod edit -replace github.com/jensneuse/graphql-go-tools=github.com/TykTechnologies/graphql-go-tools@6ff6aba4c612
go get github.com/TykTechnologies/tyk@759840e40b2e5c69c3a42d6e7d2e92def92aef01
```
{{< tab_end >}}
{{< tab_start "3.0.5" >}}
```bash
...
go get github.com/TykTechnologies/tyk@647b8ab989381b94b45e47da6ec0a565a47c46cb
```
{{< tab_end >}}
...
{{< tab_start "v3.0.7" >}}
```bash
docker run --rm -v `pwd`:/plugin-source tykio/tyk-plugin-compiler:v3.0.7 plugin.so
```
{{< tab_end >}}
{{< tab_start "3.0.6" >}}
```bash
docker run --rm -v `pwd`:/plugin-source tykio/tyk-plugin-compiler:v3.0.6 plugin.so
```
{{< tab_end >}}
{{< tab_start "3.0.5" >}}
```bash
docker run --rm -v `pwd`:/plugin-source tykio/tyk-plugin-compiler:v3.0.5 plugin.so
```
{{< tab_end >}}
{{< tab_start "3.0.4" >}}
```bash
docker run --rm -v `pwd`:/plugin-source tykio/tyk-plugin-compiler:v3.0.4 plugin.so
```
{{< tab_end >}}
...
2. Make sure to specify your Tyk version via a Docker tag. For example `v3.0.7` . 
